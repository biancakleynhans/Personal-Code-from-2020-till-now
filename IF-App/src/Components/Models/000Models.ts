...
export interface iFoodItemComplete{
    ...
    selectedServing: {
        servingSizeString: any,  // selected serving size in Serving select use this value to do map for call on right cal needs 
        quantity: number,
...
export interface iMeal{
    ...
    id: any
    MealId:string,
    macros: {    // meals Total macros from all food items toghter who on there turn has own macros 
        calories: number,
        protein:number, 
        carbs:number,
        fat: number,
