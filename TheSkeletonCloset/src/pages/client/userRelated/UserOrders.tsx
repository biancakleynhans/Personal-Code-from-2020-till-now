...
import PopUpload from "../../../components/reusable/PopUpload";
import { iInfoBase } from "../../../models/Basic";
import { colorCoder, colorMarker } from "../../../layout/ColorCoders";

interface iProps {
  curr: iInfoBase;
}

export default function UserOrders(props: iProps) {
