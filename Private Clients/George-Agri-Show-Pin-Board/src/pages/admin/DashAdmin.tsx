...
export default function DashAdmin() {
  ...
  const [showcreatingChecklist, setshowCreatingChecklist] = useState<boolean>(false);
            ...
            <IonRow>
              ...
              <IonCol>
                ...
                <IonButton
                  ...
                  expand='full'
                  onClick={() => {
                    setshowCreatingChecklist(!showcreatingChecklist);
                  }}
                >
              ...
              <IonCol className='ion-align-self-center'>
                ...
                <CheckListAdmin
                  AllUsers={allUsers}
                  creating={showcreatingChecklist}
                  setCreating={() => {
                    setshowCreatingChecklist(!showcreatingChecklist);
                  }}
                />
