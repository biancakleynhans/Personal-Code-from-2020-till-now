...
export default function UserProtectedRoute(props: { path: string; comp: React.ComponentType<any> }) {
  ...
  return curr_user !== null && (curr_user.role == "user" || curr_user.role == "super") ? (
