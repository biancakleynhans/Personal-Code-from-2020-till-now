...
const text3 =
  'The Verblyfhuis is a retreat and not an overnight stay. The 50 km trip takes at least 1.5 hours to complete when the road is in good condition. So, stay a few days.';
