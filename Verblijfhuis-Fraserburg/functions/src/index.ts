...
const cors = require("cors")({ origin: true }); //https://verblijfhuis-fraserburg.web.app/
...
exports.sendContactEmail = functions.https.onRequest((req: any, res: any) => {
  ...
  cors(req, res, () => {
    ...
    const mailOptions = {
      from: email,
      to: "henk.d.louwrens@gmail.com, webfusiononline265@gmail.com, bianca.kleynhans93@gmail.com",
