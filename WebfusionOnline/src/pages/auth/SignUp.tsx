...
export default function SignUp() {
  ...
  return (
    <IonPage>
      <IonContent>
        <HeaderComponent title={"Sign Up"} showBanner={false} />
        ...
        <IonList>
          <IonItem lines='none'>
            ...
            <IonInput required style={{ "--background": "rgba(35,11,79,0.3)", "--color": "black" }} value={fName} onIonChange={(e) => setfName(e.detail.value!)}></IonInput>
          </IonItem>
          {/* Last name */}
          <IonItem lines='none'>
            <IonLabel style={{ fontSize: "22px", padding: "11.5px" }} position='stacked'>
            ...
            <IonInput required style={{ "--background": "rgba(35,11,79,0.3)", "--color": "black" }} value={lName} onIonChange={(e) => setlName(e.detail.value!)}></IonInput>
          </IonItem>
          {/* Phone number */}
          <IonItem lines='none'>
            <IonLabel style={{ fontSize: "22px", padding: "11.5px" }} position='stacked'>
