...
import { PrettyProduct } from "../../models/Product_models";
...
export default function PrintProductUpload() {
  ...
  const [batchData, setbatchData] = useState<PrettyProduct[]>([]);
  ...
  return (
    <IonCard>
      ...
      <IonCardContent>
        ...
        <IonItem lines='none'>
          <IonLabel style={{ fontSize: "22.5px", padding: "11.5px" }} position='stacked'>
            Paper / Material types * (Please write all options separated by comma (,) )
          </IonLabel>
