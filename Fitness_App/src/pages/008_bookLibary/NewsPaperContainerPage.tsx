...
export class NewsPaperContainerPage extends Component<iProps, iState> {
	...
	GetBooks() {
		...
		GetAllBooksFromServer(TypesToServer.Books.TydSkrif)
			.then(snapshot => {
	...
	render() {
		...
		return (
			<IonPage style={{ textAlign: 'center' }}>
				<PageHeader titleString={LablesList.Page_Header_Names.Libary.news.af} />
				<IonContent>
					<IonCard>
						<IonGrid>
							<IonRow>
...
export default NewsPaperContainerPage;
