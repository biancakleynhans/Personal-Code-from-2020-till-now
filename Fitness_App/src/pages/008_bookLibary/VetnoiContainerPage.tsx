...
export class VetnoiContainerPage extends Component<iProps, iState> {
	...
	GetBooks() {
		...
		GetAllBooksFromServer(TypesToServer.Books.KoebaaiVetnoi)
			.then(snapshot => {
	...
	render() {
		...
		return (
			<IonPage style={{ textAlign: 'center' }}>
				<PageHeader titleString={LablesList.Page_Header_Names.Libary.vetnoi.af} />
				<IonContent>
					<IonCard>
						<IonGrid>
							<IonRow>
...
export default VetnoiContainerPage;
