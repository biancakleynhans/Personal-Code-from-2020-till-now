...
export class VloermoerPage extends Component<i, iState> {
	...
	constructor(props: any) {
		...
		firebaseStorageBucket
			.ref(TypesToServer.Cards.Vloermoer)
			.listAll()
			.then(result => {
	...
	render() {
		...
		return (
			<IonPage style={{ textAlign: 'center' }}>
				<PageHeader titleString={LablesList.Page_Header_Names.Vloermoer.af} />
