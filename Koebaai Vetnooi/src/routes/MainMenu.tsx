    ...
    <IonMenu type='overlay' contentId='main'>
      <IonHeader>
        <IonToolbar>
          ...
          <IonCardTitle style={{ color: "var(--ion-text-color)" }}>{props.name ? props.name : Translate(lsInj.transDict.Username)}</IonCardTitle>
          <IonCardTitle style={{ color: "var(--ion-text-color)" }}>{reg3}</IonCardTitle>
