...
import { i_BaseInterface_Location_Full } from '../../../models/001UserModels';
import { User_Update_Location } from '../../../services/redux/actions/001UserActions';
			...
			<>
				<IonItem className='eventInput'>
					...
					<IonInput
						...
						onIonChange={(e) => this.onAddressChange(e)}
						clearInput
					/>
				</IonItem>
				<IonButton onClick={this.onQuery}>
				...
				{this.props.type === 'userUpdate' && (
					<IonButton
						disabled={this.state.address.label.length === 0 ? true : false}
						onClick={() => this.saveUserLocChanege()}>
...
const mapDispatchToProps = (dispatch: Dispatch<any>) => {
	return {
		setUserAdress: (data: i_BaseInterface_Location_Full) =>
			dispatch(User_Update_Location(data))
	};
};
