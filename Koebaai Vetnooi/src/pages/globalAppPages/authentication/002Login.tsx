...
import { IonPage, IonContent, IonAvatar, IonItem, IonInput, IonButton, IonCardTitle, IonCard, IonCardContent, IonGrid, IonRow, IonCol } from '@ionic/react';
		...
		return (
			<IonPage>
				<IonContent>
					...
					{/* <IonButton class='ion-text-wrap' shape='round' fill='solid' routerLink='/reset'>
